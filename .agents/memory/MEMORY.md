...
- [Windows CI desktop build](windows-ci-desktop-build.md) — .exe built via GitHub Actions in it2w/game-world-hub; win32 natives must NOT be excluded in pnpm overrides; eb26 dropped win signing keys.
