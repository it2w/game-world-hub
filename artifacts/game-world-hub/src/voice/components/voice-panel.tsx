...
export function VoicePanel() {
  ...
  return (
    <>
      ...
      {theater && (() => {
        const allPeople = [
          ...(me ? [{ name: me.displayName, avatarUrl: me.avatarUrl ?? null, speaking: effectiveSpeaking && !effectiveMuted, muted: effectiveMuted }] : []),
          ...effectivePeers.map(p => ({ name: p.displayName, avatarUrl: p.avatarUrl ?? null, speaking: p.speaking && !p.muted, muted: p.muted })),
        ];
