...
- Name: lfg.spec.ts >> LFG post deletion >> delete button removes the card immediately for the author and hides it from other users after reload
- Location: e2e/lfg.spec.ts:227:3
