// Design 3 — Apex Legends / FPS style
  ...
  return (
    <div style={{ background:"#080808", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:32 }}>
      <div style={{ width:660, background:"#0a0a0a", border:"1px solid #1c1c1c", overflow:"hidden", position:"relative" }}>
        ...
        <div style={{ position:"absolute", top:0, left:0, bottom:0, width:4, background:"linear-gradient(180deg,#F97316,#C2410C)", boxShadow:"0 0 20px #F9731688" }} />

        {/* bg texture */}
        <div style={{ position:"absolute", inset:0, opacity:0.04, background:"radial-gradient(circle at 70% 50%, #F97316 0%, transparent 60%)" }} />
        ...
        <div style={{ padding:"24px 28px 24px 36px", display:"flex", gap:28, alignItems:"stretch", position:"relative" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:10, width:140, flexShrink:0 }}>
            <svg viewBox="0 0 80 92" style={{ width:110, height:127, filter:"drop-shadow(0 0 16px #F9731666)" }}>
              <defs>
              ...
              <path d={SHIELD} fill="#F97316" opacity="0.12" transform="scale(1.12) translate(-4,-4.5)" />
              <path d={SHIELD} fill="url(#d3g)" />
              <path d={INNER}  fill="rgba(0,0,0,0.28)" />
              <path d={SHIELD} fill="url(#d3s)" />
              <path d={SHIELD} fill="none" stroke="#FB923C" strokeWidth="2.5" opacity="0.85" />
            ...
            {/* division chip */}
            <div style={{ background:"#F97316", padding:"3px 14px", fontFamily:"monospace", fontSize:11, fontWeight:900, color:"black", letterSpacing:"0.15em", clipPath:"polygon(8px 0%, 100% 0%, calc(100% - 8px) 100%, 0% 100%)" }}>
              DIV I
            </div>
          </div>

          {/* divider */}
          <div style={{ width:1, background:"linear-gradient(180deg, transparent, #F9731666, transparent)", flexShrink:0 }} />
          ...
          <div style={{ flex:1, display:"flex", flexDirection:"column", justifyContent:"center", gap:12 }}>
            ...
            {/* tier name */}
            <div>
              <div style={{ fontFamily:"monospace", fontSize:9, color:"#F97316aa", letterSpacing:"0.35em", textTransform:"uppercase", marginBottom:4 }}>الرتبة الحالية</div>
              <div style={{ fontFamily:"'Arial Black',sans-serif", fontSize:38, fontWeight:900, color:"white", lineHeight:1, marginBottom:2 }}>
                محارب <span style={{ fontSize:16, color:"#F97316", fontFamily:"monospace", fontWeight:400 }}>WARRIOR</span>
              </div>
            ...
            <div>
              ...
              <div style={{ height:5, background:"#161616", border:"1px solid #2a2a2a", position:"relative" }}>
                <div style={{ width:"25%", height:"100%", background:"linear-gradient(90deg,#C2410C,#F97316)", boxShadow:"0 0 10px #F9731666" }} />
                {/* tick marks */}
                {[33,66].map(p=>(
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:8 }}>
              {[["4","الحلفاء"],["1","الطلبات"],["0","البارتيات"],["0","الرسائل"]].map(([n,l])=>(
                <div key={l} style={{ background:"#111", border:"1px solid #1e1e1e", padding:"8px 6px", textAlign:"center" }}>
                  <div style={{ fontFamily:"monospace", fontSize:18, fontWeight:900, color:"#F97316" }}>{n}</div>
